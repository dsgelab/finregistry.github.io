...
\
Please create a new virtual machine (VM) as soon as possible to be able
to use the new tools. The data manager can backup your data to SD
Connect. Email the data manager for help.

SD Desktop underwent quite a few changes recently, but the internal
documentation has not yet been updated to include those.
